...
mkdir -p ~/httpserver/shells
mkdir -p ~/httpserver/enum
mkdir -p ~/httpserver/privesc
mkdir -p ~/ligolo-ng/

cp /usr/share/peass/winpeas/winPEASx64.exe ~/httpserver/enum/
cp /usr/share/peass/winpeas/winPEASx86.exe ~/httpserver/enum/
cp /usr/share/peass/linpeas/linpeas.sh ~/httpserver/enum/

cp /usr/share/windows-resources/mimikatz/Win32/mimikatz.exe ~/httpserver/privesc/mimikatz32.exe
cp /usr/share/windows-resources/mimikatz/x64/mimikatz.exe ~/httpserver/privesc/mimikatz64.exe

cp /usr/share/windows-resources/binaries/nc.exe ~/httpserver/shells/
cp /usr/share/webshells/ ~/httpserver/shells/
...
sed -i -e 's:plugins.*:plugins=(git zsh-autocomplete zsh-autosuggestions zsh-syntax-highlighting):g' ~/.zshrc
